  ...
  (setq multi-compile-completion-system 'helm
        ...
        '(;; Elasticsearch-specific compilation commands
          ((s-contains? "es/elasticsearch" default-directory)
           . (("ES core compile"
              ...
              ("ES core check"
               ...
               "~/es/elasticsearch")
              ("ES backport check"
               "./gradlew compileJava compileTestJava precommit :server:check --console=plain"
               "~/es/elasticsearch")
          ...
          ((s-contains? "elasticsearch-extra/x-pack" default-directory)
           . (("x-pack compile"
               "./gradlew :x-pack-elasticsearch:plugin:compileJava :x-pack-elasticsearch:plugin:compileTestJava --console=plain"
