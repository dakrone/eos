...
(use-package helm-config
  ...
  (("C-M-z" . helm-resume)
   ...
   ("C-c C-o" . helm-occur)
   ("C-x M-o" . helm-occur)
   ("C-x C-o" . helm-occur)   ("M-y" . helm-show-kill-ring)
   ("C-h a" . helm-apropos)
...
(defhydra eos/hydra nil
  ...
  ("A" eos/hydra-about-emacs/body "About" :exit t)
  ...
  ("W" sunshine-forecast "Weather" :exit t)
  ("q" nil "quit" :exit t))
...
(use-package prodigy
  ...
  (progn
    ...
    (prodigy-define-service
      ...
      :cwd "~/ies/elasticsearch-2.1.1"
      :command "~/ies/elasticsearch-2.1.1/bin/elasticsearch"
      :tags '(work test es)
      :port 9200)))
#+END_SRC
