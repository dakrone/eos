...
(use-package prodigy
  ...
  (prodigy-define-service
    ...
    :port 9200)
  (prodigy-define-service
    :name "Elasticsearch 2.4.3"
    :cwd "~/ies/elasticsearch-2.4.3"
    :command "~/ies/elasticsearch-2.4.3/bin/elasticsearch"
    :tags '(work test es)
    :port 9200)
  (prodigy-define-service
  ...
  (prodigy-define-service
    ...
    :cwd "~/ies/elasticsearch-5.3.0"
    :command "~/ies/elasticsearch-5.3.0/bin/elasticsearch"
    :tags '(work test es)
    :port 9200)
  (prodigy-define-service
    :name "ES gradle run"
