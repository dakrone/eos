...
(use-package magit
  ...
  (bind-key "M-1" 'eyebrowse-switch-to-window-config-1 magit-mode-map)
  (bind-key "M-2" 'eyebrowse-switch-to-window-config-2 magit-mode-map)
  (bind-key "M-3" 'eyebrowse-switch-to-window-config-3 magit-mode-map)
  (bind-key "M-4" 'eyebrowse-switch-to-window-config-4 magit-mode-map)
