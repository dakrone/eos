...
(use-package prodigy
  ...
  (prodigy-define-service
    :name "Kibana 5.0.0"
    :cwd "~/ies/kibana-5.0.0-linux-x64_86"
    :command "~/ies/kibana-5.0.0-linux-x64_64/bin/kibana"
    :tags '(work kibana)
    :port 5601)
  ...
  (prodigy-define-service
    ...
    :cwd "~/ies/elasticsearch-2.4.1"
    :command "~/ies/elasticsearch-2.4.1/bin/elasticsearch"
    :tags '(work test es)
    :port 9200)
  (prodigy-define-service
    :name "Elasticsearch 5.0.0"
    :cwd "~/ies/elasticsearch-5.0.0"
    :command "~/ies/elasticsearch-5.0.0/bin/elasticsearch"
    :tags '(work test es)
    :port 9200)
  (prodigy-define-service
    :name "ES gradle run"
