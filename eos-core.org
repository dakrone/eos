...
#+RESULTS:
: ((#\+BEGIN_EXAMPLE . #\+END_EXAMPLE) (#\+BEGIN_SRC . #\+END_SRC) (:\(PROPERTIES\|LOGBOOK\): . :END:) ([^ -\377]+) (ispell-words-keyword forward-line) (ispell-dictionary-keyword forward-line) (ispell-pdict-keyword forward-line) (ispell-parsing-keyword forward-line) (^---*BEGIN PGP [A-Z ]*--* . ^---*END PGP [A-Z ]*--*) (^begin [0-9][0-9][0-9] [^ 	]+$ .
: end
: ) (^%!PS-Adobe-[123].0 .
: %%EOF
