...
;; a o e are on the home row for Dvorak keyboards on the left hand, h is on the home row for the
;; right hand
(global-set-key (kbd "M-a") 'eos/create-or-switch-to-eshell-1)
(global-set-key (kbd "M-o") 'eos/create-or-switch-to-eshell-2)
(global-set-key (kbd "M-e") 'eos/create-or-switch-to-eshell-3)
(global-set-key (kbd "M-h") 'eos/create-or-switch-to-eshell-4)
#+END_SRC
