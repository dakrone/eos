...
(defvar eos/default-font-height 130
...
(if (eq eos/background 'dark)
  ...
  (use-package tao-theme
    ...
    (load "~/.emacs.d/site-lisp/local-theme.el")
    ;;(load-theme 'local t)
...
(setq eos/original-height 130)

(defun eos/setup-fonts ()
  (when (or (display-graphic-p) (daemonp))
    (with-demoted-errors "FONT ERROR: %s"
      (set-face-attribute 'default nil :height eos/default-font-height :family eos/font)
      (set-face-attribute 'fixed-pitch nil :family eos/font)
