  ...
  (setq multi-compile-completion-system 'helm
        ...
        '(;; Elasticsearch-specific compilation commands
          ((s-contains? "es/elasticsearch" default-directory)
           . (("ES core compile"
               "./gradlew :core:compileJava :core:compileTestJava --console=plain"
               "~/es/elasticsearch")
              ...
              ("ES core unit test"
               ...
               "~/es/elasticsearch")
              ("ES core integ test"
               "./gradlew :core:integTest --console=plain"
               "~/es/elasticsearch")
              ("ES core check"
               "./gradlew :core:check --console=plain"
               "~/es/elasticsearch")
              ("ES documentation tests"
               "./gradlew :docs:check --console=plain"
               "~/es/elasticsearch")
              ("ES REST tests"
               "./gradlew :distribution:integ-test-zip:integTest -Dtests.class=\"org.elasticsearch.test.rest.*Yaml*IT\" --console=plain"
               "~/es/elasticsearch")
              ("ES core precommit"
               "./gradlew :core:precommit --console=plain"
               "~/es/elasticsearch")
              ("ES precommit"
          ...
          ((s-contains? "elasticsearch-extra/x-pack" default-directory)
           . (("x-pack compile"
               "./gradlew :x-pack:elasticsearch:x-pack:compileJava :x-pack:elasticsearch:x-pack:compileTestJava --console=plain"
