...
When using punpun theme, let's try out [[https://github.com/ankurdave/color-identifiers-mode][color-identifiers-mode]]

#+BEGIN_SRC emacs-lisp
(use-package color-identifiers-mode
  :ensure t
  :init (add-hook 'emacs-lisp-mode-hook #'color-identifiers-mode))
#+END_SRC
...
(use-package racer
  ...
  (use-package company-racer
    :ensure t
    :init
    (push 'company-racer company-backends-rust-mode))
