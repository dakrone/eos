...
=transient-mark-mode= and only relying on =visible-mark-mode= for showing the mark, which alleviates
...
(use-package visible-mark
  ...
  (set-face-attribute 'visible-mark-active nil :background "#888888")
