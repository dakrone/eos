...
We need to source that for SDKMan if needed too

#+BEGIN_SRC sh :tangle out/bashrc.d/sdkman.sh
export PATH=$PATH:~/.sdkman/candidates/gradle/current/bin
export PATH=$PATH:~/.sdkman/candidates/groovy/current/bin
    ...
    (add-hook 'c-mode-common-hook
              (lambda ()
                (when (derived-mode-p 'c-mode 'c++-mode 'java-mode 'asm-mode)
                  ...
                  (eos/setup-helm-gtags) ;; helm-gtags
                  ;;(my/setup-ggtags) ;; regular gtags
                  )))))
#+END_SRC

Need to set up some bash things for gtags to work

#+BEGIN_SRC sh :tangle out/bashrc.d/gtags.sh
if [ -f ~/.globalrc ]; then
