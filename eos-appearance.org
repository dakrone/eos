...
(if (eq eos/background 'dark)
    (progn
      ...
      (use-package doom-themes
        ...
        ;; Enable nlinum line highlighting requires nlinum and hl-line-mode
        (require 'doom-nlinum)
  ...
  (use-package tao-theme
    ...
    (set-face-attribute 'git-gutter-fr:added nil :foreground "green"))
  ;; (progn
  ;;   (when (file-exists-p "~/src/elisp/dakrone-light-theme")
  ;;     (add-to-list 'custom-theme-load-path
  ;;                  "~/src/elisp/dakrone-light-theme")
  ...
  (when (eq window-system 'x)
    ...
    (dolist (face '(mode-line mode-line-inactive minibuffer-prompt))
      (set-face-attribute face nil :family "Inconsolata"
                          :height (- eos/original-height 10)))
    (set-face-attribute 'variable-pitch nil
                        :family "Merriweather" :height (- eos/original-height 10))
